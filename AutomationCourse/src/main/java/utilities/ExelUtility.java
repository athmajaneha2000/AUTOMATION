...
public class ExelUtility
{
		...
		{
			f=new FileInputStream("C:\\Users\\Admin\\git\\AUTOMATION\\AutomationCourse\\src\\test\\resources\\TestData.xlsx");// it is the location of file
		...
		{
			f=new FileInputStream("C:\\Users\\Admin\\git\\AUTOMATION\\AutomationCourse\\src\\test\\resources\\TestData.xlsx");
